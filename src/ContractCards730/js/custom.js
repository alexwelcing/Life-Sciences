...
function createSource(arr) {
    var html = '\
    <li id="source'+arr.id+'" data-tab="source'+arr.id+'"><a href="https://www.legis.nd.gov/cencode/t26-1c36.pdf#nameddest=26p1-36-09p15" target="_blank">'+arr.description+'</a></li>';
    HTML3.push(html);
}
